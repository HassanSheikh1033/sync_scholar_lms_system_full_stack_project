...
<head>
    ...
    <title>Course Management - SyncScholar</title>
...
<body>
            ...
            <main class=" ms-sm-auto px-md-4">
                <div class="page-header animate__animated animate__fadeIn">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
                        <h1 class="h2"><i class="fas fa-book-open me-2"></i>Course Management</h1>
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <button type="button" class="btn btn-primary animate__animated animate__bounceIn animate__delay-1s" data-bs-toggle="modal" data-bs-target="#courseModal">
                ...
                <div class="card animate__animated animate__fadeInUp">
                    <div class="card-body">
                        ...
                        <div id="noCourses" class="empty-state d-none animate__animated animate__fadeIn">
                            <div class="empty-state-icon">
                                <i class="fas fa-book-open"></i>
                            </div>
                            <h4>No Courses Found</h4>
                            <p class="text-muted">Get started by adding your first course</p>
                            <button class="btn btn-primary mt-3" data-bs-toggle="modal" data-bs-target="#courseModal">
                                <i class="fas fa-plus"></i> Add New Course
                            </button>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="courseModalLabel"><i class="fas fa-edit me-2"></i>Add New Course</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-center">Are you sure you want to delete this course? This action cannot be undone.</p>
    ...
    <script>
        // Add this script to enhance the UI with dynamic elements
